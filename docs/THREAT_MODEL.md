...
description and scope are listed in the system prompt; its body is read only
when the model calls the `skill` tool with that name. Twenty installed skills
