...
| Bash filesystem reach after approval | REDUCED | On Termux, approved bash runs with the full authority of the Termux app user; there is no filesystem sandbox. |
