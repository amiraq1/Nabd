...
## ٨. برهان تكامل واتحاد الفروع الثلاثة (PRs #155 / #156 / #157)

* **تاريخ التحقق:** 2026-09-19
* **النتيجة:** دُمجت الفروع الثلاثة (`feat/ctrl-c-policy`، `feat/feed-scroll-pointer`، `feat/copy-export-pipeline`) في اتحاد ثلاثي كامل بصفر تعارضات عند الالتزام `6c089cd` (المحفوظ محلياً في الفرع `tmp/ui-union`).
