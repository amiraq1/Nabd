...
- **Operation Definition:** Each timed iteration measures a sequence of $K$ sequential Backspace edits executed against a freshly prepared $N$-rune input (prepared during benchmark setup outside `b.ResetTimer()`).
